...
public class UserController {
    ...
    public ResponseEntity signUp(@RequestBody @Validated(ValidationGroups.signUp.class) Users user) throws Exception{
    ...
    public ResponseEntity signIn(@RequestBody @Validated(ValidationGroups.signIn.class) Users user) throws Exception{
    ...
    public ResponseEntity findId(@RequestBody @Validated(ValidationGroups.findId.class) Users user) throws Exception {
    ...
    public ResponseEntity findPassword(@RequestBody @Validated(ValidationGroups.findPassword.class) Users user) throws Exception{
    ...
    public ResponseEntity changePassword(@RequestBody @Validated(ValidationGroups.changePassword.class) Users user){
